...
try:
  ...
  print(f"\033[92m[save_webp-avif]\033[0m AVIF is not supported. To add it: pip install pillow pillow-avif-plugin\033[0m") 
  pass
else:
  print(f"\033[92m[save_webp-avif] AVIF is supported! Woohoo!\033[0m") 
  avif_supported = True
...
"""
  ...
  print(f"\033[92m[save_webp-avif]\033[0m version: {version}\033[0m")
#  if avif_supported:
