...
98 = Near-Lossless.  (filesize: ~71%)   
97 = Start of soft-banding.  (filesize: ~53%)   
96 = High quality final image.  (filesize: ~42%)   
80 = Normal quality.  (filesize: ~17%)   
60 = Draft/test images.  (filesize: ~11%)   
